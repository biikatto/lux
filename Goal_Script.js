...
function OnTriggerEnter (other : Collider) {
  ...
  function OnGUI(){
    	GUI.skin = GuiSkin3;
  // 		GUI.Label(labelPos, "P1:" + score); 
   		GUI.Label(Rect((Screen.width * 0.25) - 75,15,150,50), "Score:" + score);
        ...
        if(score == maxScore) {
			GUI.skin = GuiSkin1;        
			GUI.Label(Rect((Screen.width-w)/2, (Screen.height-h)/2, w, h), "Player 1 Wins!!");
         }
  }